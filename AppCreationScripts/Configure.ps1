...
#> 
   ...
   Write-Host "Creating the AAD application (python-django-webapp-authn)"
   ...
   $webAppAadApplication = New-AzureADApplication -DisplayName "python-django-webapp-authn" `
                                                  -HomePage "http://localhost:8000" `
                                                  -ReplyUrls "http://localhost:8000/auth/redirect" `
                                                  -IdentifierUris "https://$tenantName/python-django-webapp-authn" `
   ...
   Write-Host "Done creating the webApp application (python-django-webapp-authn)"
   ...
   Add-Content -Value "<tr><td>webApp</td><td>$currentAppId</td><td><a href='$webAppPortalUrl'>python-django-webapp-authn</a></td></tr>" -Path createdApps.html
